...
public class CreateEventFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // TODO: initialize views for registration open and close dates
        ...
        if (mode == EventCreationMode.EDIT) {
            ...
            // TODO: add fields for registration open/close dates
        ...
        positiveButton.setOnClickListener(v -> {
            // Gather and validate user entries
            ...
            /*
                TODO: somehow get the organizerId into the event generated by validateInput().
    ...
    private ValidationResult validateInput(ValidationContext ctx) {
        ...
        // TODO: validate registration open and close dates
        ...
        if (mode == EventCreationMode.CREATE) {
            returnEvent = new Event(
                    ...
                    ctx.organizerId,
                    new Date(), // TODO: change from temporary var to user input
                    new Date(), // TODO: change from temporary var to user input
                    capacity
            );
        } else {
            ...
            // TODO: update registration open/close times
