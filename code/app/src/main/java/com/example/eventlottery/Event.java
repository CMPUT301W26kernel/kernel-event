 ...
 *       filtering and such. DO.NOT.CHANGE.TYPE.
 * </p>
 *
...
public class Event {
    ...
    String title;
    String description;
    String organizerId; // Read only. This should be autogenerated by Firebase, similarly to the eventId
    String timeZone; // TODO: add this so that Firestore can deserialize a Timestamp that we convert to ZonedDateTime.
